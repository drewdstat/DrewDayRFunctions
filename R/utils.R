...
myvarcompsummary_cat_tab<-function(catnames,Data,compvar=NULL,catvarnames=NULL,kable=T,roundplace=2,
                                   fontsize=12,totalcol=F,nmissing=F,sigtest=T,allcomplete=F){
  library(rcompanion)
